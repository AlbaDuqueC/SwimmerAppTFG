...
interface ApiService {
    ...
    @GET("nadador/email/{email}") suspend fun obtenerNadadorPorEmail(@Path("email") email: String): Response<ApiResponseDto<NadadorResponseDto>>
    ...
    @GET("marcadetiempo/nadador/{id}") suspend fun obtenerMarcasPorNadador(@Path("id") id: Int): Response<ApiResponseDto<List<MarcaDeTiempoResponseDto>>>
