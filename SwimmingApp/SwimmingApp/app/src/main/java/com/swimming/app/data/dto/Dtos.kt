...
data class EquipoRequestDto(@SerializedName("nombre") val nombre: String, @SerializedName("idEntrenador") val idEntrenador: Int?)
...
data class RutinaResponseDto(@SerializedName("id") val id: Int, @SerializedName("idRutina") val idRutina: Int, @SerializedName("contenido") val contenido: String, @SerializedName("fecha") val fecha: String, @SerializedName("mostrar") val mostrar: Boolean, @SerializedName("idUsuario") val idUsuario: Int)data class MarcaDeTiempoRequestDto(
    @SerializedName("tiempo") val tiempo: String,
    @SerializedName("descripcion") val descripcion: String,
    @SerializedName("idNadadorEquipo") val idNadadorEquipo: Int?,  // 👈 nullable
...
data class VincularCodigoRequestDto(@SerializedName("codigo") val codigo: Int)
